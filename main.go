...
func main() {
	dsn := "root:@tcp(127.0.0.1:3306)/khisoft_campaign?charset=utf8mb4&parseTime=True&loc=Local"
	...
	api.POST("/campaigns/:id", authMiddleware(authService, userService), campaignHandler.GetCampaign)
